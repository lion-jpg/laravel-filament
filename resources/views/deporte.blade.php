...
<body>
    <nav>
        ...
        <button id="openModalBtn" class="btn-ge">Agregar Contenido</button>
    ...
    <div id="formModal" class="modal">
        <div class="modal-content">
            ...
            <form action="{{ url('admin/d_post') }}" method="POST" enctype="multipart/form-data">
                ...
                <input type="text" id="descri" name="descri"></input>

                <label for="foto_dep">Fotografia:</label>
                <input type="file" id="foto_dep" name="foto_dep" accept="image/*">
    ...
    <div id="editModal" class="modal">
        <div class="modal-content">
            ...
            <form id="editForm" method="POST" enctype="multipart/form-data">
                ...
                <input type="text" id="edit_descri" name="descri">
                ...
                <input type="file" id="edit_foto_dep" name="foto_dep" accept="image/*" onchange="previewImage(event)">
    ...
    function openEditModal(data, id) {
        ...
        document.getElementById("editForm").action = "{{ url('admin/d_post') }}/" +
