...
<body>
    ...
    <div id="formModal" class="modal">
        <div class="modal-content">
            ...
            <form action="{{ url('/c_post') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <!-- <pre>{{ print_r($data['data'], true) }}</pre> -->
                    @foreach ($data['data'] as $item)
                        @if (isset($item['attributes']['foto_dep']['data']['attributes']['url']))
                            ...
                            <tr>
                                <td>
                                    <img class="img" src="{{ 'https://backend-culturas.elalto.gob.bo'.$item['attributes']['foto_dep']['data']['attributes']['url'] }}" alt="Image" >
                                </td>
